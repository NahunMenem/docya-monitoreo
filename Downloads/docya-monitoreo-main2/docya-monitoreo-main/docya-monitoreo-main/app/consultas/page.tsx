        ...
        <div className="glass-card overflow-hidden">
          ...
          <div className="overflow-x-auto">
            <table className="data-table">
              <thead>
                <tr>
                  {["ID", "Fecha", "Estado", "Paciente", "Motivo", "Profesional", "Tipo consulta", "Canal", "Pago", "Dirección", "Llegada", "Duración", ""].map((h) => (
                    <th key={h}>{h}</th>
                  ))}
                </tr>
              </thead>
                ...
                {filtradas.map((c) => {
                  ...
                  return (
                    <tr key={c.id}>
                      ...
                      <td className="max-w-[180px] truncate text-xs" title={c.motivo || "Sin motivo informado"}>
                        {c.motivo || "Sin motivo informado"}
                      </td>
                      <td>{c.profesional}</td>
                      <td>
                      ...
                      <td>
                        <span className={`badge ${c.canal_atencion === "teleconsulta" || c.tipo === "teleconsulta" ? "badge-blue" : "badge-teal"}`}>
                          {c.canal_atencion === "teleconsulta" || c.tipo === "teleconsulta" ? "Teleconsulta" : "Domicilio"}
                        </span>
                      </td>
